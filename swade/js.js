...
function adicionaFicha(personagem){
	...
	+" 		<button onclick='inserirNome("+pos+")' type='button' class='btn btn-dark'>"
	+" 		Inserir"
	+" 		</button>"
	+" 	</form>"
	+" </div>"
	...
	+"</span>"
	+" 	<div id='boxAtributos' class='mb-3'>"
	+"  <span class='text-right'> Agilidade:"+personagem.atributos.agilidade+"</span><br/>"
	+"  <span class='text-right'> Astúcia:"+personagem.atributos.astucia+"</span><br/>"
	+"  <span class='text-right'> Espirito:"+personagem.atributos.espirito+"</span><br/>"
	+"  <span class='text-right'> Força:"+personagem.atributos.forca+"</span><br/>"
	+"  <span class='text-right'> Vigor:  "+personagem.atributos.vigor+"</span><br/>"
	+"  </div>"
	...
	if (personagem.pericias.atirar) {$ ('#ficha'+personagem.pos).append("<span>Atirar</span>: <span>"+personagem.pericias.atirar+"</span> <br>")};
	if (personagem.pericias.atletismo) {$ ('#ficha'+personagem.pos).append("<span>Atletismo</span>: <span>"+personagem.pericias.atletismo+"</span> <br>")};
	if (personagem.pericias.cavalgar) {$ ('#ficha'+personagem.pos).append("<span>Cavalgar</span>: <span>"+personagem.pericias.cavalgar+"</span> <br>")};
	if (personagem.pericias.dirigir) {$ ('#ficha'+personagem.pos).append("<span>Dirigir</span>: <span>"+personagem.pericias.dirigir+"</span> <br>")};
	if (personagem.pericias.furtividade) {$ ('#ficha'+personagem.pos).append("<span>Furtividade</span>: <span>"+personagem.pericias.furtividade+"</span> <br>")};
	if (personagem.pericias.ladinagem) {$ ('#ficha'+personagem.pos).append("<span>Ladinagem</span>: <span>"+personagem.pericias.ladinagem+"</span> <br>")};
	if (personagem.pericias.lutar) {$ ('#ficha'+personagem.pos).append("<span>Lutar</span>: <span>"+personagem.pericias.lutar+"</span> <br>")};
	if (personagem.pericias.navegar) {$ ('#ficha'+personagem.pos).append("<span>Navegar</span>: <span>"+personagem.pericias.navegar+"</span> <br>")};
	if (personagem.pericias.pilotar) {$ ('#ficha'+personagem.pos).append("<span>Pilotar</span>: <span>"+personagem.pericias.pilotar+"</span> <br>")};
	if (personagem.pericias.intimidar) {$ ('#ficha'+personagem.pos).append("<span>Intimidar</span>: <span>"+personagem.pericias.intimidar+"</span> <br>")};
	if (personagem.pericias.performance) {$ ('#ficha'+personagem.pos).append("<span>Performance</span>: <span>"+personagem.pericias.performance+"</span> <br>")};
	if (personagem.pericias.persuadir) {$ ('#ficha'+personagem.pos).append("<span>Persuadir</span>: <span>"+personagem.pericias.persuadir+"</span> <br>")};
	if (personagem.pericias.ciencia) {$ ('#ficha'+personagem.pos).append("<span>Ciência</span>: <span>"+personagem.pericias.ciencia+"</span> <br>")};
	if (personagem.pericias.conAcademico) {$ ('#ficha'+personagem.pos).append("<span>Conhec. Acadêmico</span>: <span>"+personagem.pericias.conAcademico+"</span> <br>")};
	if (personagem.pericias.conBatalha) {$ ('#ficha'+personagem.pos).append("<span>Conhec. Batalha</span>: <span>"+personagem.pericias.conBatalha+"</span> <br>")};
	if (personagem.pericias.conGeral) {$ ('#ficha'+personagem.pos).append("<span>Conhec. Geral</span>: <span>"+personagem.pericias.conGeral+"</span> <br>")};
	if (personagem.pericias.consertar) {$ ('#ficha'+personagem.pos).append("<span>Consertar</span>: <span>"+personagem.pericias.consertar+"</span> <br>")};
	if (personagem.pericias.curar) {$ ('#ficha'+personagem.pos).append("<span>Curar</span>: <span>"+personagem.pericias.curar+"</span> <br>")};
	if (personagem.pericias.eletronica) {$ ('#ficha'+personagem.pos).append("<span>Eletrônica</span>: <span>"+personagem.pericias.eletronica+"</span> <br>")};
	if (personagem.pericias.hackear) {$ ('#ficha'+personagem.pos).append("<span>Hackear</span>: <span>"+personagem.pericias.hackear+"</span> <br>")};
	if (personagem.pericias.idiomas) {$ ('#ficha'+personagem.pos).append("<span>Idiomas</span>: <span>"+personagem.pericias.idiomas+"</span> <br>")};
	if (personagem.pericias.jogar) {$ ('#ficha'+personagem.pos).append("<span>Jogar</span>: <span>"+personagem.pericias.jogar+"</span> <br>")};
	if (personagem.pericias.ocultismo) {$ ('#ficha'+personagem.pos).append("<span>Ocultismo</span>: <span>"+personagem.pericias.ocultismo+"</span> <br>")};
	if (personagem.pericias.perceber) {$ ('#ficha'+personagem.pos).append("<span>Perceber</span>: <span>"+personagem.pericias.perceber+"</span> <br>")};
	if (personagem.pericias.pesquisar) {$ ('#ficha'+personagem.pos).append("<span>Pesquisar</span>: <span>"+personagem.pericias.pesquisar+"</span> <br>")};
	if (personagem.pericias.provocar) {$ ('#ficha'+personagem.pos).append("<span>Provocar</span>: <span>"+personagem.pericias.provocar+"</span> <br>")};
	if (personagem.pericias.sobrevivencia) {$ ('#ficha'+personagem.pos).append("<span>Sobrevivência</span>: <span>"+personagem.pericias.sobrevivencia+"</span> <br>")};
